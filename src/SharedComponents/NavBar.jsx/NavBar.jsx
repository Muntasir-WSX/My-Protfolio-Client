...
const NavBar = () => {
  ...
  const NavItem = ({ link, mobile = false }) => {
    // মোবাইল এবং ডেস্কটপ দুই জায়গাতেই একই বেইস স্টাইল
      ...
      <div className="container mx-auto flex justify-between items-center h-24">
        ...
        <div className="hidden lg:flex items-center gap-10">
          <ul className="flex gap-8 items-center">
            ...
            {isAdmin && (
              <li>
                <RouterLink to="/muntasir-admin" className="text-gray-400 hover:text-orange-500 uppercase font-medium tracking-widest text-[11px] transition-all cursor-pointer">
                  Admin
                </RouterLink>
              </li>
            )}
          ...
          {user && (
            <button onClick={handleSignOut} className="btn btn-sm btn-outline border-orange-600 text-white hover:bg-orange-600 rounded-full px-8 transition-all uppercase text-[10px] font-bold cursor-pointer">
              Sign Out
            </button>
          )}
        </div>
        ...
        {isOpen && (
          <div className="fixed inset-0 z-[120]">
            ...
            <motion.div
              ...
              className="absolute top-0 left-0 h-full w-[280px] bg-[#0d0d0d] border-r border-gray-800 flex flex-col z-[130]"
            >
