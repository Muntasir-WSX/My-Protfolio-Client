...
const Banner = () => {
  const socialLinks = [
    {
      icon: <FaGithub />,
      link: "https://github.com/Muntasir-WSX",
      name: "GitHub",
    },
    {
      icon: <FaLinkedinIn />,
      link: "https://www.linkedin.com/in/muntasir-mahmud-aa4291278/",
      name: "LinkedIn",
    },
    {
      icon: <FaInstagram />,
      link: "https://www.instagram.com/muntasir_wsx/",
      name: "Instagram",
    },
    {
      icon: <FaFacebookF />,
      link: "https://www.facebook.com/muntasir.mahmud.9843",
      name: "Facebook",
    },
  ];
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center bg-[#0a0a0a] overflow-hidden px-6 md:px-16 py-12"
    >
      ...
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-0 items-center z-10">
        ...
        >
          ...
          <div className="relative w-full max-w-70 md:max-w-95 lg:max-w-112.5">
            ...
            >
              <p className="text-orange-600 font-bold text-[10px] uppercase tracking-tighter">
                Experience
              </p>
        ...
        <div className="order-2 lg:order-1 relative z-20 -mt-12 lg:mt-0 text-center lg:text-left">
          ...
          >
            ...
            >
              Transforming your ideas into cutting-edge web solutions. I craft
